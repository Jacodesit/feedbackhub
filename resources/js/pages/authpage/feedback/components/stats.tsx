    ...
    return (
        ...
        >
            {cards.map((card, index) => (
                <div
                    key={index}
                    className="group bg-white border border-gray-100 rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-300 hover:border-gray-200 hover:shadow-[0_12px_40px_rgba(0,0,0,0.03)] flex justify-between items-center max-w-sm w-full h-32 relative overflow-hidden"
                >
