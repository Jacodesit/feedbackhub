        ...
        <section className="p-20 bg-black">
            <div className="px-20 max-w-7xl mx-auto">
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-8 max-w-5xl">
                        <h1 className="text-white text-2xl md:text-5xl font-bold tracking-tight text-center leading-[1.1]">
                            Ready to turn raw feedback into clear action? <br />
                            <span className="text-black/40">Stop guessing what users need</span>
                        </h1>

                        <p className="text-white/80 text-base text-center max-w-2xl font-light">
                        ...
                        <button
                            className="group relative px-10 py-4 bg-black rounded-full text-base font-medium text-white
